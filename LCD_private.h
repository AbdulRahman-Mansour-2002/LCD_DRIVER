...
#define LCD_RS_LOW(LCD)						(MGPIO_voidSetPinValue(LCD->ControlPorts[0],LCD->ControlPins[0],GPIO_LOW))
#define LCD_RS_HIGH(LCD)					(MGPIO_voidSetPinValue(LCD->ControlPorts[0],LCD->ControlPins[0],GPIO_HIGH))

#define LCD_RW_LOW(LCD)						(MGPIO_voidSetPinValue(LCD->ControlPorts[1],LCD->ControlPins[1],GPIO_LOW))
#define LCD_RW_HIGH(LCD)					(MGPIO_voidSetPinValue(LCD->ControlPorts[1],LCD->ControlPins[1],GPIO_HIGH))
